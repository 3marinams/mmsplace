...
export default function Skills() {
    ...
    <section id="skills">
        ...
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center md:w-3/3">
            <div className="flex justify-between mx-auto md:w-3/3 w-full px-10 py-3">
                {skills.map((skill) => (
                    <div key={skill} className="p-2 sm:w-1/2">
                    <div className="border border-blue-900 border-solid border-1 rounded flex flex-col p-4 items-center max-w-lg h-36 mx-auto text-center justify-center items-center">
                        {/* <BadgeCheckIcon className="text-green-400 w-6 h-6 flex-shrink-0 mr-4" /> */}
